...
class TestDataCleaner:
    ...
    def test_deduplicate_by_priority(self, cleaner, sample_records):
        ...
        first_window_records = [r for r in result_records
    ...
    def test_merge_overlapping_records(self, cleaner):
        ...
        records = [
            ...
            HealthRecord(
                type="HKCategoryTypeIdentifierSleepAnalysis",
                source_name="🐙Watch",
                start_date=base_time + timedelta(minutes=30, seconds=2),  # 2秒间隔，应该合并
        ...
        result_records = cleaner.merge_overlapping_records(records, merge_threshold_seconds=5)
